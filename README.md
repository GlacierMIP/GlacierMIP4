...
- **Ice thickness**: GlacierMIP4 uses the data by [Maffezzoli et al. (2026)](https://arxiv.org/abs/2512.11685). Initial ice volumes are supplied both at the individual-glacier ([here](https://zenodo.org/records/17724512)) and glacier complex level ([here](https://zenodo.org/records/20463551)) as well as aggregated by RGI region (**Table 1**). Modelers may either adopt these provided initial volumes directly or generate their own year-2000 volumes using model-specific spin-up procedures. In the latter case, the resulting **regional ice volumes** must agree with the reference values in **Table 1** within **±10%**.
